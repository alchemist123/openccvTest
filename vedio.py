...
fourcc = cv2.VideoWriter_fourcc(*'XVID') # Define the code and create VideoWriter object ,it is resloution
out = cv2.VideoWriter('vedios.avi',fourcc,20.0,(640,480)) # creating a video writer objet which consist of save file name.avi/mp4 etc fourcc ,no: of frames per sec, hieght and width of frame
cap.set(3,720)
cap.set(4,720)
